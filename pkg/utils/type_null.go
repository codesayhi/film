...
//	Logic:
//	Value là giá trị
//	Set: Người dùng gửi file này lên khi cập nhật
//	Valid: Có giá trị (Khác Null) và Không có giá trị Null
//	Nếu người dùng muốn cập nhật 1 file là Null thì : Set = true và valid = false
//	Nếu người dùng cập nhật 1 file có giá trị thì Set = true và Valid = true
//	Nếu người dùng Update và không gửi field(trường vd: name,age,..) thì set = false
